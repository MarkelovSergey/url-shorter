...
const file_shortener_proto_rawDesc = "" +
	"\n" +
	"\x0fshortener.proto\x12\tshortener\x1a!google/protobuf/go_features.proto\"%\n" +
	...
	"\foriginal_url\x18\x02 \x01(\tR\voriginalUrl\"\x15\n" +
	"\x13ListUserURLsRequest2\xf2\x01\n" +
	...
	"\fListUserURLs\x12\x1e.shortener.ListUserURLsRequest\x1a\x1b.shortener.UserURLsResponseB5Z+github.com/MarkelovSergey/url-shorter/proto\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"
...
var file_shortener_proto_goTypes = []any{
	...
	(*ListUserURLsRequest)(nil), // 6: shortener.ListUserURLsRequest
}
var file_shortener_proto_depIdxs = []int32{
	...
	6, // 3: shortener.ShortenerService.ListUserURLs:input_type -> shortener.ListUserURLsRequest
